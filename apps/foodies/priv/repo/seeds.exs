...
ingredients_in_location = [
  %{ingredient_id: 1, location_id: 1},
  %{ingredient_id: 2, location_id: 1},
  %{ingredient_id: 3, location_id: 1},
  %{ingredient_id: 4, location_id: 1},
  %{ingredient_id: 5, location_id: 2},
  %{ingredient_id: 6, location_id: 1},
  %{ingredient_id: 7, location_id: 2}
]

Enum.map(
  ingredients_in_location,
  fn ingredient ->
    changeset = IngredientLocation.changeset(%IngredientLocation{}, ingredient)
    Repo.insert!(changeset)
  end
)
...
#   to_recipe_category,
#   fn recipe_category ->
#     changeset = RecipeCategory.changeset(%RecipeCategory{}, recipe_category)
#     Repo.insert!(changeset)
#   end
# )
